...
public class UserToGroupTest {
  ...
  public com.entities.List createTestLists(){
    com.entities.List list;
    
    list = new com.entities.List("To-dos",groups.get(0),members.get(0));
  ...
  public void addItemsToList(){
    List<com.entities.List> groupLists = new ArrayList<com.entities.List>(groupDao.retrieve(groups.get(0).getID()).getGroupLists());
    com.entities.List list = groupLists.get(0); 
    Item item;
